 ...
 *
 * Both directions are optional — implement only what you need. Methods are called on the main thread.
 *
...
interface QaLensCrashBridge {
     ...
     */
    fun enrich(crash: QaLensCrash, evidence: String)
     ...
     */
    fun onCrash(callback: (QaLensCrash) -> Unit)
}
